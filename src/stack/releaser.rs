...
pub struct ReleaseOrchestrator {
    ...
    pub(super) config: ReleaseConfig,
...
impl ReleaseOrchestrator {
    ...
    // Note: check_* methods are now in releaser_preflight.rs module
...
// Note: ReleaseResult, ReleasedCrate, format_plan_text are now in releaser_types.rs module
