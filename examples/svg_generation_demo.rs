...
fn main() {
    ...
    println!("   Contains GRID PROTOCOL MANIFEST: {}", stack_svg.contains("GRID PROTOCOL MANIFEST"));
    ...
    println!("   Cells used: {} / 144 ({:.0}%)", grid.cells_used(), grid.cells_used() as f32 / 144.0 * 100.0);
    ...
    println!("   Slide title:    {}px {} ({})", vt.slide_title.size, vt.slide_title.weight, vt.slide_title.family);
    println!("   Section header: {}px {} ({})", vt.section_header.size, vt.section_header.weight, vt.section_header.family);
    ...
    println!("   heading on canvas:  pass={}", VideoPalette::verify_contrast(&dark_palette.heading, &dark_palette.canvas));
    println!("   heading on surface: pass={}", VideoPalette::verify_contrast(&dark_palette.heading, &dark_palette.surface));
    println!("   accent_gold on canvas: pass={}", VideoPalette::verify_contrast(&dark_palette.accent_gold, &dark_palette.canvas));
    println!("   body on canvas:     pass={}\n", VideoPalette::verify_contrast(&dark_palette.body, &dark_palette.canvas));
    ...
    println!("   min_text_size:       {}px", linter.lint_text_size(18.0, None).map_or("PASS".to_string(), |v| v.message));
    println!("   17px text:           {}", linter.lint_text_size(17.0, None).map_or("PASS".to_string(), |v| v.message));
    println!("   2px stroke:          {}", linter.lint_stroke_width(2.0, None).map_or("PASS".to_string(), |v| v.message));
    println!("   1px stroke:          {}", linter.lint_stroke_width(1.0, None).map_or("PASS".to_string(), |v| v.message));
    println!("   20px padding:        {}", linter.lint_internal_padding(20.0, None).map_or("PASS".to_string(), |v| v.message));
    println!("   15px padding:        {}", linter.lint_internal_padding(15.0, None).map_or("PASS".to_string(), |v| v.message));
